                ...
                <div class="grid items-center grid-cols-1 gap-y-6 md:grid-cols-2 md:gap-x-20">
                        ...
                        <ul class="flex items-center space-x-3 mt-9">
                            <li>
                                <a href="https://www.instagram.com/g_wayne_1/?hl=en" title=""
                                    class="flex items-center justify-center text-white transition-all duration-200 bg-blue-500 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                    ...
                    <div class="relative pl-20 pr-6 sm:pl-6 md:px-0">
                        <div class="relative w-full max-w-xs mt-4 mb-10 ml-auto">
                            <img class="ml-auto" src="../assets/WhatsApp Image 2024-10-07 at 21.03.50.jpeg" alt="" />
                            ...
                            <div class="absolute -bottom-10 -left-16">
                                <div class="bg-blue-100 rounded-2xl">
                                    <div class="px-6 py-5">
                                        <img src="https://cdn0.iconfinder.com/data/icons/editorial-darkmode/24/editorial_html-512.png"
