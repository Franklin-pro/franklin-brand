  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
      <div class="mr-auto place-self-center lg:col-span-7">
        <h1
          class="max-w-2xl mb-4 text-4xl font-black leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
          Franklin <br>ND developer.
        </h1>

        <h3 class="capitalize text-blue-400">I'm <span
            class="typing text-green-500 font-bold dark:text-green-700">Fullstack Developer</span></h3>
        <p>Experienced full-stack developer with 4+ years of expertise in React Js(TS), Nest Js(TS), Nuxt Js(TS), Next
      ...
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img src="../assets/WhatsApp Image 2024-10-07 at 21.03.50.jpeg" alt="hero image">
      </div>
