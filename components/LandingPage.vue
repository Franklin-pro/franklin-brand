        ...
        <div class="grid items-center grid-cols-1 gap-y-6 md:grid-cols-2 md:gap-x-20">
            <div class="">
                ...
                <p class="mt-4 text-base leading-relaxed text-gray-600">   i'm full-stack web developer,i can make good website if you are interested you can
                  ...
                  <ul class="flex items-center space-x-3 mt-9">
                    <li>
                        <a href="https://www.instagram.com/g_wayne_1/?hl=en" title="" class="flex items-center justify-center text-white transition-all duration-200 bg-blue-500 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                    ...
                    <li>
                        <a href="https://github.com/Franklin-pro" title="" class="flex items-center justify-center text-white transition-all duration-200 bg-blue-500 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
            ...
            <div class="relative pl-20 pr-6 sm:pl-6 md:px-0">
                <div class="relative w-full max-w-xs mt-4 mb-10 ml-auto">
                    <img class="ml-auto" src="../assets/me.png" alt="" />
