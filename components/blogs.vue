                ...
                <div class="p-5">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="px-4 py-2 text-xs font-semibold tracking-widest text-gray-900 uppercase bg-white rounded-full">{{ item.status }}</span>
                        </div>
                    </div>
                    <span class="block mt-6 text-sm font-semibold tracking-widest text-gray-500 uppercase">{{ item.date }} </span>
                    <p class="mt-5 text-2xl font-semibold">
                        <a href="#" title="" class="text-black"> {{ item.heading }} </a>
                    </p>
...
const items = [
  ...
  },
  {
    ...
    status:"MARKERTING",
    date:'21-march-2020',
    heading:"Ho7 Tips to run your remote team faster and better.",
    description:"Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit."
  },
  {
    id:3,
    ...
    status:"PRODUCTIVITY",
    date:'April 04, 2020 ',
    heading:"5 Productivity tips to write faster at morning.",
    description:"Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit."
  },
]
</script>
