            ...
            <div v-if="filteredBlogs.length > 0" v-for="item in filteredBlogs" :key="item.id">
              <div class="p-5 bg-white rounded-xl">
                ...
                <p class="mt-5 text-2xl font-semibold">
                  <a href="#" title="" class="text-black text-base font-black truncate">{{ item.blogName }}</a>
                </p>
                ...
                <a :href="item._id" title="" class="inline-flex items-center justify-center pb-0.5 mt-5 text-base font-semibold text-blue-600 transition-all duration-200 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600">
                  Continue Reading
