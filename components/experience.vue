    ...
    <section class="py-10 bg-gray-100 dark:bg-gray-800 sm:py-16 lg:py-24">
      <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
          <div class="max-w-2xl mx-auto text-center">
              ...
              <p class="mt-3 text-xl leading-relaxed text-gray-400 md:mt-8">My two years of coding experience, as well as the work I completed for clients.</p>
          </div>
          ...
          <div class="grid grid-cols-1 gap-8 mt-10 text-center lg:mt-24 sm:gap-x-8 md:grid-cols-3">
              <div>
                  ...
                  <p class="mt-4 text-xl font-medium text-gray-400">Years in business</p>
              ...
              <div>
                  ...
                  <p class="mt-4 text-xl font-medium text-gray-400">Projects delivered in my self</p>
                  <p class="text-base mt-0.5 text-gray-500">In last 1 years</p>
              </div>
  
              <div>
                  <h3 class="font-bold text-7xl">
                      <span class="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-blue-600"> 7+ </span>
                  </h3>
                  <p class="mt-4 text-xl font-medium text-gray-400">Team members</p>
