<template>
            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <p class="text-base leading-relaxed text-gray-600 mt-7"> As a full-stack web developer, I am
                            capable of creating a top-notch website. If you are interested, please contact me on</p>

                        <ul class="flex items-center space-x-3 mt-9">
                            <li>
                                <a href="https://www.linkedin.com/in/franklin-ndanyuzwe-00113431a/" target="_blank" title=""
                                    class="flex items-center justify-center text-white transition-all duration-200  rounded-full w-7 h-7">
    ...
    <path d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z M17,20v19h-6V20H17z M11,14.47c0-1.4,1.2-2.47,3-2.47s2.93,1.07,3,2.47c0,1.4-1.12,2.53-3,2.53C12.2,17,11,15.87,11,14.47z M39,39h-6c0,0,0-9.26,0-10 c0-2-1-4-3.5-4.04h-0.08C27,24.96,26,27.02,26,29c0,0.91,0,10,0,10h-6V20h6v2.56c0,0,1.93-2.56,5.81-2.56 c3.97,0,7.19,2.73,7.19,8.26V39z"></path>
                            ...
                            <li>
                                <a href="https://github.com/Franklin-pro" title=""
                                    class="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="currentColor">
                ...
                <p class="text-sm text-center text-gray-600">copyright &copy; {{ new Date().getFullYear() }}, All Rights
                    Reserved by Franklin</p>
            </div>
        </section>
